...
export default function PokerApp() {
  ...
  const transact = (functionName:'createTable'|'joinTable'|'leaveTable'|'startHand'|'act'|'forceTimeoutFold', args:readonly unknown[]) => {
...
function GameTable({id,address,close,transact}:{id:bigint,address?:`0x${string}`,close:()=>void,transact:(name:'joinTable'|'leaveTable'|'startHand'|'act'|'forceTimeoutFold',args:readonly unknown[])=>void}){
